  ...
  return (
    <>
      ...
      {/* Swim Spa Master Section */}
       <section className="relative h-[700px] text-white flex items-center">
        <video autoPlay loop muted playsInline className="absolute top-0 left-0 w-full h-full object-contain z-0" poster="https://placehold.co/1920x400.png">
