...
const galleryImages = [
  { src: 'https://placehold.co/800x600.png', alt: 'Ultra model hot tub at night', dataAiHint: 'luxury hot tub' },
  { src: 'https://placehold.co/800x600.png', alt: 'Close-up of the jets', dataAiHint: 'water jets' },
  { src: 'https://placehold.co/800x600.png', alt: 'Family enjoying the Ultra hot tub', dataAiHint: 'family relaxing' },
  { src: 'https://placehold.co/800x600.png', alt: 'Ultra hot tub in a backyard setting', dataAiHint: 'backyard spa' },
];
