    ...
    <section data-studio-id={docPath} className="py-16 sm:py-24 bg-muted">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="pr-8">
            <p data-studio-id={`${docPath}/props/subtitle`} className="text-primary font-semibold mb-2">{subtitle}</p>
            <h2 data-studio-id={`${docPath}/props/title`} className="text-3xl font-bold mb-4">{title}</h2>
            <p data-studio-id={`${docPath}/props/description`} className="text-muted-foreground mb-4">
              {description}
            </p>
          ...
          <div data-studio-id={`${docPath}/props/brands`} data-studio-id-mode="reorder" className="grid grid-cols-2 gap-4">
            {brands.map((brand, index) => (
                <div key={brand.name} data-studio-id={`${docPath}/props/brands/${index}`}>
                    <Image 
                        src={brand.logoUrl} 
                        alt={`${brand.name} Logo`}
                        width={400} 
                        ...
                        data-studio-id={`${docPath}/props/brands/${index}/logoUrl`}
                    />
                </div>
            ))}
          </div>
